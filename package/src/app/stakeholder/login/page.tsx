...
export default function StakeholderLogin() {
  ...
  return (
    <PageContainer title="Stakeholder Login" description="Stakeholder login page">
          ...
          <Grid display="flex" justifyContent="center" alignItems="center" size={{ xs: 12, sm: 12, lg: 4, xl: 3 }}>
            <Card elevation={9} sx={{ p: 4, zIndex: 1, width: "100%", maxWidth: "500px" }}>
              ...
              <AuthLogin
                ...
                subtext={<Typography variant="subtitle1" textAlign="center" color="textSecondary" mb={1}>Submit and track your feedback</Typography>}
                subtitle={
                  <Stack direction="row" spacing={1} justifyContent="center" mt={3}>
                    <Typography color="textSecondary" variant="h6" fontWeight="500">New user?</Typography>
                    <Typography component={Link} href="/stakeholder/register" fontWeight="500" sx={{ textDecoration: "none", color: "primary.main" }}>Create an account</Typography>
                  </Stack>
                }
