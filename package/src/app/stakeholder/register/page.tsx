...
export default function StakeholderRegister() {
  return (
    <PageContainer title="Stakeholder Register" description="Stakeholder registration page">
          ...
          <Grid display="flex" justifyContent="center" alignItems="center" size={{ xs: 12, sm: 12, lg: 4, xl: 3 }}>
            <Card elevation={9} sx={{ p: 4, zIndex: 1, width: "100%", maxWidth: "500px" }}>
              ...
              <AuthRegister
                ...
                subtext={<Typography variant="subtitle1" textAlign="center" color="textSecondary" mb={1}>Participate in eConsultations</Typography>}
                subtitle={
                  <Stack direction="row" spacing={1} justifyContent="center" mt={3}>
                    <Typography color="textSecondary" variant="h6" fontWeight="500">Already have an account?</Typography>
                    <Typography component={Link} href="/stakeholder/login" fontWeight="500" sx={{ textDecoration: "none", color: "primary.main" }}>Sign in</Typography>
                  </Stack>
                }
              />
            </Card>
